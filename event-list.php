                    ...
                    <tr>
                        <td>
                            <div class="card" style="width:100%;">
                                <div class="row ">
                                    <div class="col-md-4">
                                        <img class="img-fluid" src="<?php echo URLROOT ?>/assets/admin/media/uploadImages/events/<?php echo (!empty($e->event_img)) ? $e->event_img:'news.png';?>" style="width:100%; height:100%;"/>
                                    </div>
