<footer class="myfooter mt-5">
  <div class="container py-5">
    <div class="row py-4">
      <div class="col-lg-6 col-md-6 mb-4 mb-lg-0"><img src="<?php echo URLROOT?>/assets/public/images/brand_logo_footer.png" alt="" width="180" class="mb-3">
    ...
    <div class="row py-4">
        ...
        <p style="font-size:26px;" class="list-inline-item"><a href="<?php echo URLROOT?>/admin/index" target="_blank" title="login"><i class="fa fa-sign-in"></i></p></li>
        </div>
    </div>
  </div>
  ...
  <div class="bg-light py-4">
    <div class="container text-center">
      <p   class="mb-0 py-2" style="color:#17A2B8;"> © <?php echo date('Y'); ?> INTEGRATED SOCIAL DEVELOPMENT CENTRE. All rights reserved.</p>
    </div>
  </div>
</footer>
<!-- Scripts -->
