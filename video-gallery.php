  ...
  <section id="page-content" style="margin-top:20px;">
      ...
      <div class="container">
        ...
        <?php foreach($videoResults as $vid): ?>
          <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="<?php echo $vid->file_name; ?>" data-fancybox="videos" data-caption="<?php echo  $vid->media_title; ?>"><img class="img-fluid" src="<?php echo URLROOT ?>/assets/admin/media/uploads/video/<?php echo $vid->video_thumbnail;?>"></a>
