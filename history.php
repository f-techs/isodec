  ...
  <section id="about-content">
    ...
    <?php if(!empty($historyID)): ?>
      <div class="col-lg-12 col-md-6 col-xs-4">
        <img class="img-fluid" src="<?php echo URLROOT ?>/assets/admin/media/uploadImages/<?php echo $historyImg ?>" style="border: 1px solid #ddd; border-radius: 4px; padding: 5px;" height="100%" width="100%"/>
