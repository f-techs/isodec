        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-6 col-xs-4">
            <?php if (!empty($data->img)) : ?>
              <img class="img-fluid" src="<?php echo (!empty($data->img)) ?  URLROOT . '/assets/admin/media/uploads/policy_support/' . $data->img : ' ' ?> " style="border: 1px solid #ddd; border-radius: 4px; padding: 5px;" height="100%" width="100%" />
            <?php endif; ?>
