 ...
 */
    ...
    class ScheduledMessageRequest extends Request {
        ...
        public function cancelSchedule($mc){
            ...
            $this->initRequest();
            $dataWriter = $this->createDataWriter();
            $this->_requestData = &$dataWriter->writeCancelScheduleRequest($mc->getTemplateId());
        ...
        public function dispatchMessage($mc){
            ...
            $this->initRequest();
            $dataWriter = $this->createDataWriter();
            $this->_requestData = &$dataWriter->writeDispatchScheduledMessageRequest($mc->getTemplateId());
