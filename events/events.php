    ...
    <?php if (!empty($eventPageTitle)) : ?>
      <div class="container">
        ...
        <div class="col-md-3 mt-3">
            <span id="badge-label" class="badge badge-pill badge-primary badge-label"><b>LOCATION:</b></span> <?= $eventlocation; ?></p>
          </div>
          <div class="col-md-3 mt-3">
            <span id="badge-label" class="badge badge-pill badge-primary badge-label"><b>DATE:</b></span> <?= $eventDate; ?></p>
          </div>
          <div class="col-md-3 mt-3">
        ...
        <div class="row mx-auto my-3">
          <div class="col-lg-12 col-md-6 col-xs-4">
            <?php echo (!empty($eventPageImg)) ?  '<img class="img-fluid" src="' . URLROOT . '/assets/admin/media/uploads/events/' . $eventPageImg . '"/>' : ''; ?>
          </div>
          <div class="col-lg-12 col-md-6 col-xs-4">
