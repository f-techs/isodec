					...
					<div class="card card-custom">
						<div class="card-header flex-wrap border-0 pt-6 pb-0">
							<div class="card-title">
								<h3 class="card-label">Blog list</h3>
							</div>
							<div class="card-toolbar">
								<!--begin::Button-->
								<a href="<?php echo URLROOT ?>/admin/pages/add-blog" class="btn btn-primary font-weight-bolder">
								...
								<tbody>
									<?php foreach ($blogListResults as $data) : ?>
										<tr>
											...
											<td><center><img src="<?php echo URLROOT ?>/assets/admin/media/uploads/blogs/<?php echo (!empty($data->blog_img)) ? $data->blog_img : 'no-image.png'; ?>" style=" border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 70px; height:70px;"></center> </td>
											<td><?php echo txtTruncate($data->blog_details, 100); ?></td>
											<td><?php echo date('d-M-Y', strtotime($data->created_date)); ?></td>
											<td>
												<div class="btn-group" role="group" aria-label="First group">
													<button type="button" id="<?php echo $data->blog_id;?>" class="btn btn-warning  btn-icon edit"><i class="la la-edit"></i></button>
													<button type="button"  id="<?php echo $data->blog_id;?>" class="btn btn-danger btn-icon delete"><i class="la la-trash"></i></button>
												</div>
											</td>
										</tr>
									<?php endforeach; ?>
