								...
								<form id="frmevent" method="Post" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="event_title" required name="event_title" class="form-control"></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-form-label text-right col-lg-2 col-sm-12">Event Date:</label>
											<div class="col-lg-10 col-md-10 col-sm-12">
												<input id="event_date" type="date" required name="event_date" class="form-control"/>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-form-label text-right col-lg-2 col-sm-12">Event Time:</label>
											<div class="col-lg-10 col-md-10 col-sm-12">
												<input id="event_time" type="time" required name="event_time" class="form-control"/>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-form-label text-right col-lg-2 col-sm-12">Type Content Here:</label>
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="event_content" name="event_content" class="form-control"></textarea>
											</div>
										</div>
										<div class="form-group row">
