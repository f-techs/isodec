									...
									<div class="card-body">
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="vision_content" name="vision_content" class="form-control" <?php echo (!empty($visionID) && $visionID == 2) ? '' : 'required'; ?>><?php echo (!empty($visionID) && $visionID == 2) ? $visionDetails : ''; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<div class="image-input image-input-outline" id="img" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/avatars/image.png)">
													<div class="image-input-wrapper" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/uploadImages/<?php echo (!empty($visionID) && ($visionID == 2)) ? $visionImg : ''; ?>)"></div>

													<label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change image">
														<i class="fa fa-pen icon-sm text-muted"></i>
														<input type="file" name="img_file" id="img_file" accept=".png, .jpg, .jpeg" <?php echo (!empty($visionID)  && !empty($visionImg) && $visionID == 2) ? '' : 'required'; ?> />
														<input type="hidden" id="image_remove_name" value="<?php echo (!empty($visionID) && ($visionID == 2)) ? $visionImg : ''; ?>" name="profile_avatar_remove" />
													</label>
													<!--
												...
												<!--remove image-->
												<span style="display:<?php echo (!empty($visionID)  && !empty($visionImg) && $visionID == 2) ? 'inline-block' : 'none'; ?>;" class="btn btn-xs btn-icon btn-circle btn-danger btn-hover-text-primary btn-shadow" id="img_remove" data-toggle="tooltip" title="Remove image">
										...
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="img_caption" name="img_caption" class="form-control" <?php echo (!empty($visionID) && $visionID == 2) ? '' : 'required'; ?>><?php echo (!empty($visionID) && $visionID == 2) ? $visionImgCaption : ''; ?></textarea>
											</div>
										</div>
									</div>
