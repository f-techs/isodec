									...
									<div class="card-body">
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="details" name="details" class="form-control" <?php echo (!empty($policyID)) ? '' : 'required'; ?>><?php echo (!empty($policyID)) ? $policyDetails : ''; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<div class="image-input image-input-outline" id="img" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/avatars/image.png)">
													...
													<label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change image">
														...
														<div id="file_wrapper">
														<input type="file" name="img_file" id="img_file" accept=".png, .jpg, .jpeg" <?php echo (!empty($policyID)  && !empty($policyImg)) ? '' : 'required'; ?> />
														</div>
														<input type="hidden" id="image_remove_name" value="<?php echo (!empty($policyID)) ? $policyImg : ''; ?>" name="profile_avatar_remove" />
													</label>
													<!--
...
-->
												...
												<!--remove image -->
												<span style="display:<?php echo (!empty($policyID)  && !empty($policyImg)) ? 'inline-block' : 'none'; ?>;" class="btn btn-xs btn-icon btn-circle btn-danger btn-hover-text-primary btn-shadow" id="img_remove" data-toggle="tooltip" title="Remove image">
													<i class="ki ki-bold-close icon-xs"></i>
												</span>
												<!--view image-->
												<span style="display:<?php echo (!empty($policyID)  && !empty($policyImg)) ? 'inline-block' : 'none'; ?>;" class="btn btn-xs btn-icon btn-circle btn-success btn-hover-text-primary btn-shadow" id="view_image" data-toggle="tooltip" title="View image">
										...
										<div class="form-group row">
											...
											<div class="col-lg-10 col-md-10 col-sm-12">
												<textarea id="img_caption" name="img_caption" class="form-control" <?php echo (!empty($policyID)) ? '' : 'required'; ?>><?php echo (!empty($policyID)) ? $policyImgCaption : ''; ?></textarea>
											</div>
										</div>
									</div>
