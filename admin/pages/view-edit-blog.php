                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-12">
                                                <div class="image-input image-input-outline" id="img" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/avatars/image.png)">
                                                    <div class="image-input-wrapper" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/uploads/blogs/<?php echo (!empty($blogImg)) ? $blogImg : ''; ?>)"></div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?php echo URLROOT ?>/assets/admin/media/uploads/blogs/<?php echo (!empty($blogImg)) ? $blogImg : ''; ?>" style="width:100%;height:100%; display:block;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
