                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-12">
                                                <textarea required id="blog_title" name="blog_title" class="form-control"><?php echo (!empty($blogTitle)) ? $blogTitle : ''; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label text-right col-lg-2 col-sm-12">Type Content Here:</label>
                                            <div class="col-lg-10 col-md-10 col-sm-12">
                                                <textarea id="blog_content" name="blog_content" class="form-control"><?php echo (!empty($blogDetails)) ? $blogDetails : ''; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-12">
                                                <div class="image-input image-input-outline" id="img" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/avatars/image.png)">
                                                    <div class="image-input-wrapper" style="background-image: url(<?php echo URLROOT ?>/assets/admin/media/uploadImages/blogs/<?php echo (!empty($blogImg)) ? $blogImg : ''; ?>)"></div>
                                                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change image">
                                                        <i class="fa fa-pen icon-sm text-muted"></i>
                                                        <div id="file_wrapper">
                                                            <input type="file" name="img_file" id="img_file" accept=".png, .jpg, .jpeg" <?php echo (!empty($blogImg)) ? '' : 'required'; ?> />
                                                        </div>
                                                        <input type="hidden" id="image_remove_name" value="<?php echo (!empty($blogImg)) ? $blogImg : ''; ?>" name="profile_avatar_remove" />
                                                        <input type="hidden" name="blog_code" id="blog_code" value="<?php echo (!empty($blogCode)) ? $blogCode : ''; ?>" name="profile_avatar_remove" />
                                                    </label>
                                                    <!--
...
-->
                                                ...
                                                <!--remove image -->
                                                <span style="display:<?php echo (!empty($blogImg)) ? 'inline-block' : 'none'; ?>;" class="btn btn-xs btn-icon btn-circle btn-danger btn-hover-text-primary btn-shadow" id="img_remove" data-toggle="tooltip" title="Remove image">
                                                    <i class="ki ki-bold-close icon-xs"></i>
                                                </span>
                                                <!--view image-->
                                                <span style="display:<?php echo (!empty($blogImg)) ? 'inline-block' : 'none'; ?>;" class="btn btn-xs btn-icon btn-circle btn-success btn-hover-text-primary btn-shadow" id="view_image" data-toggle="tooltip" title="View image">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-12">
                                                <textarea id="img_caption" name="img_caption" class="form-control"><?php echo (!empty($blogImgCaption)) ? $blogImgCaption : ''; ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="<?php echo URLROOT ?>/assets/admin/media/uploadImages/blogs/<?php echo (!empty($blogImg)) ? $blogImg : ''; ?>" style="width:100%;height:100%; display:block;" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
