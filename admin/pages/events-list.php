					...
					<div class="card card-custom">
						<div class="card-header flex-wrap border-0 pt-6 pb-0">
							...
							<div class="card-toolbar">
								<!--begin::Button-->
								<a href="<?php echo URLROOT ?>/admin/pages/add-events" class="btn btn-primary font-weight-bolder">
							...
							<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
								<thead>
									<tr>
										...
										<th title="Field #2">Event Image</th>
										<th title="Field #3">Event Details</th>
								...
								<tbody>
									<?php foreach ($eventListResults as $data) : ?>
										<tr>
											...
											<td><center><img src="<?php echo URLROOT ?>/assets/admin/media/uploadImages/events/<?php echo (!empty($data->event_img)) ? $data->event_img : ''; ?>" style=" border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 70px; height:70px;"></center> </td>
											<td><?php echo txtTruncate($data->event_details, 100); ?></td>
											<td><?php echo date('d-M-Y', strtotime($data->created_date)); ?></td>
											<td>
												<div class="btn-group" role="group" aria-label="First group">
													<button type="button" id="<?php echo $data->event_id;?>" class="btn btn-warning  btn-icon edit"><i class="la la-edit"></i></button>
													<button type="button"  id="<?php echo $data->event_id;?>" class="btn btn-danger btn-icon delete"><i class="la la-trash"></i></button>
												</div>
											</td>
										</tr>
									<?php endforeach; ?>
