								...
								<tbody>
									<?php foreach ($newsListResults as $data) : ?>
										<tr>
											...
											<td><center><img src="<?php echo URLROOT ?>/assets/admin/media/uploads/news/<?php echo (!empty($data->news_img)) ? $data->news_img : 'no-image.png'; ?>" style=" border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 70px; height:70px;"></center> </td>
