...
//foreach( $email as $cleintmail){
    ...
    foreach($email as $clientmail){
    $mail->addAddress($clientmail);//Receiver Email
    $mail->addReplyTo('noreply@isodec.com');
    }
    if(!empty($file_name)){ 
       $mail->addAttachment(APPROOT.'/assets/admin/media/email-uploads/'.$file_name);
    }
    $mail->isHTML(true);
  ...
  <html>
    ...
    <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
      <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">ISODEC GHANA EVENT NOTIFICATION.</span>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">ISODEC GHANA, Accra - Ghana</span>
                    </td>
                  </tr>
                  <tr>
